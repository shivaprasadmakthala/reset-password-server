...
module.exports = async (email, token) => {
    try{
        ...
        let mailOptions = {
            ...
            <a href="" target="_blank" style="font-size: 1rem; padding: 0.75rem; border: none; border-radius: 5px; text-decoration: none; background-color: rgb(76, 175, 75); color: whitesmoke; cursor: pointer;"> Reset Now</a>
            </div>`,
        };
